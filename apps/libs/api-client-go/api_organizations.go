...
type OrganizationsAPI interface {
	...
	*/
	...
	/*
	GetOrganizationReferralCode Get or initialize an organization invitation code

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId Organization ID
	@return OrganizationsAPIGetOrganizationReferralCodeRequest
	*/
	GetOrganizationReferralCode(ctx context.Context, organizationId string) OrganizationsAPIGetOrganizationReferralCodeRequest

	// GetOrganizationReferralCodeExecute executes the request
	//  @return OrganizationReferralCodeDto
	GetOrganizationReferralCodeExecute(r OrganizationsAPIGetOrganizationReferralCodeRequest) (*OrganizationReferralCodeDto, *http.Response, error)
...
type OrganizationsAPIGetOrganizationReferralCodeRequest struct {
	ctx context.Context
	ApiService OrganizationsAPI
	organizationId string
}

func (r OrganizationsAPIGetOrganizationReferralCodeRequest) Execute() (*OrganizationReferralCodeDto, *http.Response, error) {
	return r.ApiService.GetOrganizationReferralCodeExecute(r)
}
...
GetOrganizationReferralCode Get or initialize an organization invitation code
 ...
 @return OrganizationsAPIGetOrganizationReferralCodeRequest
*/
func (a *OrganizationsAPIService) GetOrganizationReferralCode(ctx context.Context, organizationId string) OrganizationsAPIGetOrganizationReferralCodeRequest {
	return OrganizationsAPIGetOrganizationReferralCodeRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return OrganizationReferralCodeDto
func (a *OrganizationsAPIService) GetOrganizationReferralCodeExecute(r OrganizationsAPIGetOrganizationReferralCodeRequest) (*OrganizationReferralCodeDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OrganizationReferralCodeDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsAPIService.GetOrganizationReferralCode")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organizations/{organizationId}/referral-code"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
